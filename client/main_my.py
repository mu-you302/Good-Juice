...
class Model(object):
    ...
    def action(self, jsonCon: dict) -> str:
        ...
        for i in range(2):
            ...
            IsSneaky = attri["isSneaky"] == True
            SneakyAble = attri["hideCDLeft"] == 0

            myPos = Point(attri["x"], attri["y"])

            if IsSneaky and SneakyAble and (MoveAble or MasterAble or SlaveAble):
                res += "i"

            if not IsSneaky or SneakyAble:
                if MasterAble:
    ...
    def ToDirection(P1: Point, P2: Point) -> int:
        ...
        if P2.x < P1.x and P2.y == P1.y:
            ...
            return 5
        elif P2.x + P2.y == P1.x + P1.y and P2.y > P1.y:
            return 0
        elif P2.x < P1.x and P2.y < P1.y:
            return random.choice([1, 2])
        elif P2.x > P1.x and P2.y > P1.y:
